<header class="bg-(--background)">
    <div class="container py-6 mx-auto flex justify-between items-center ">
        ...
        <div>
            <img class=" h-14 md:h-20" src="http://jawaaf.com/storage/01JTAR172JR8ZT7NTGZQX93FTB.png" alt="Jawaf Logo">
        </div>
        <div>
            {{-- <span class="text-xl">बिहिबार, २२ माघ २०८२</span> --}}
            <span class=" text-base md:text-xl">{{ toNepaliDate(now()) }}</span>
            <img class=" h-3 md:h-4" src="{{ asset('frontend/images/redline.png') }}" alt="line">
        </div>

    </div>


    <nav class="bg-(--primary-color) py-2 text-white ">
        <div class="container flex justify-between items-center">
            ...
            <div class="fixed bottom-1  left-0 lg:static">
